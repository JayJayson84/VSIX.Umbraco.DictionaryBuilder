...
namespace DictionaryBuilder
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SyncStagingToLive
    {
        ...
        /// Command ID.
        /// </summary>
        public const int CommandId = 0x1052;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncStagingToLive"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private SyncStagingToLive(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in SyncStagingToLive's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new SyncStagingToLive(package, commandService);
        }
        ...
        /// </summary>
        public static SyncStagingToLive Instance
        {
            get;
            private set;
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            var title = "Synchronise the dictionary tables from <Staging> to <Live>.";
            ...
            ThreadHelper.JoinableTaskFactory.RunAsync(async () =>
            {
                ...
                {
                    await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync();
                    LogHelper.LogToWindow("DictionaryBuilder: Starting synchronisation from <Staging> to <Live>...", true);
                    LogHelper.LogToWindow(string.Empty, true);
                    await TaskScheduler.Default;

                    await SqlService.SynchroniseDictionaryAsync(options.SqlConnections.Staging, options.SqlConnections.Live, options.EncryptionMethod);
