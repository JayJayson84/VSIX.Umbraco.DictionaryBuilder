...
namespace DictionaryBuilder
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SyncDevelopmentToStaging
    {
        ...
        /// Command ID.
        /// </summary>
        public const int CommandId = 0x1041;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncDevelopmentToStaging"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private SyncDevelopmentToStaging(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in SyncDevelopmentToStaging's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new SyncDevelopmentToStaging(package, commandService);
        }
        ...
        /// </summary>
        public static SyncDevelopmentToStaging Instance
        {
            get;
            private set;
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            var title = "Synchronise the dictionary tables from <Development> to <Staging>.";
            ...
            ThreadHelper.JoinableTaskFactory.RunAsync(async () =>
            {
                ...
                {
                    await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync();
                    LogHelper.LogToWindow("DictionaryBuilder: Starting synchronisation from <Development> to <Staging>...", true);
                    LogHelper.LogToWindow(string.Empty, true);
                    await TaskScheduler.Default;

                    await SqlService.SynchroniseDictionaryAsync(options.SqlConnections.Development, options.SqlConnections.Staging, options.EncryptionMethod);
