...
namespace DictionaryBuilder
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SyncStagingToDevelopment
    {
        ...
        /// Command ID.
        /// </summary>
        public const int CommandId = 0x1051;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncStagingToDevelopment"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private SyncStagingToDevelopment(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in SyncStagingToDevelopment's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new SyncStagingToDevelopment(package, commandService);
        }
        ...
        /// </summary>
        public static SyncStagingToDevelopment Instance
        {
            get;
            private set;
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            var title = "Synchronise the dictionary tables from <Staging> to <Development>.";
            var message = "All existing data in the <Development> dictionary tables will be truncated prior to the import. It is strongly recommended to backup the database first.\n\nDo you want to continue?";
            ...
            ThreadHelper.JoinableTaskFactory.RunAsync(async () =>
            {
                ...
                {
                    await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync();
                    LogHelper.LogToWindow("DictionaryBuilder: Starting synchronisation from <Staging> to <Development>...", true);
                    LogHelper.LogToWindow(string.Empty, true);
                    await TaskScheduler.Default;

                    await SqlService.SynchroniseDictionaryAsync(options.SqlConnections.Staging, options.SqlConnections.Development, options.EncryptionMethod);
