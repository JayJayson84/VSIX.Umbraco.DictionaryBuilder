...
namespace DictionaryBuilder
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SyncLiveToDevelopment
    {
        ...
        /// Command ID.
        /// </summary>
        public const int CommandId = 0x1061;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncLiveToDevelopment"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private SyncLiveToDevelopment(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in SyncLiveToDevelopment's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new SyncLiveToDevelopment(package, commandService);
        }
        ...
        /// </summary>
        public static SyncLiveToDevelopment Instance
        {
            get;
            private set;
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            var title = "Synchronise the dictionary tables from <Live> to <Development>.";
            ...
            ThreadHelper.JoinableTaskFactory.RunAsync(async () =>
            {
                ...
                {
                    await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync();
                    LogHelper.LogToWindow("DictionaryBuilder: Starting synchronisation from <Live> to <Development>...", true);
                    LogHelper.LogToWindow(string.Empty, true);
                    await TaskScheduler.Default;

                    await SqlService.SynchroniseDictionaryAsync(options.SqlConnections.Live, options.SqlConnections.Development, options.EncryptionMethod);
